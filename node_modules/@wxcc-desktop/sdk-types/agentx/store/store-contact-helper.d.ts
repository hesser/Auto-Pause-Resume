...
import { Task } from "./store-agent-contact";
export declare const getPrimaryMediaParticipants: (data: Task) => InteractionControlNS.MediaParticipants;
export declare const getIsConsultInProgress: (data: Task) => boolean;
...
export declare const isParticipantInMainInteraction: (data: any, agentId: string) => boolean;
