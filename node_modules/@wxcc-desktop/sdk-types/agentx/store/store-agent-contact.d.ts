...
export type Task = Service.Aqm.Contact.AgentContact["data"];
export type TaskMap = Map<TaskId, Task>;
...
export declare class ModuleAgentContact {
    ...
    get contact(): {
        ...
        queueId: string;
        enterpriseId: string;
        chatMessages: Service.Cms.ChatTemplateResponse;
    };
    ...
    setIsWebCallMuted(muteValue?: boolean): void;
