...
export declare function aqmAgent(aqm: AqmReqs, http: HttpReqs): {
    reload: import("../../core/aqm-reqs").ResEmpty<Agent.ReloginSuccess>;
    ...
    mockOutdialAniList: import("../../core/aqm-reqs").Res<Agent.OutdialAniListSuccess, unknown>;
    fetchAddressBooks: (p: unknown, cb?: ((res: any) => void | Agent.AddressBooks) | undefined) => Promise<Agent.AddressBooks>;
